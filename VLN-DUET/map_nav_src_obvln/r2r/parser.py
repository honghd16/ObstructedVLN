...
def parse_args():
    ...
    # # dynamic environment
    parser.add_argument('--max_train_edge', default=0, type=int)
    parser.add_argument('--max_eval_edge', default=0, type=int)
    parser.add_argument('--use_inpaint', action='store_true', default=False)
    parser.add_argument('--seen_stop', action='store_true', default=False)
    parser.add_argument('--search_target', action='store_true', default=False)
...
def postprocess_args(args):
    ...
    args.lm_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', 'inpaint_features.hdf5')
